...
import { downloadAsDocx, downloadAsDoc } from '../../utils/generador-docx.util';
import { getRomanNumeral } from '../../../../shared/utils/words.util';
import { parseDateToNumeric } from '../../../../shared/utils/date.util';
import { generateAgreementMarkdown } from '../../utils/formateador-acuerdo.util';
import { ControlesAcuerdoComponent } from './controles-acuerdo/controles-acuerdo.component';
import { CertificacionAcuerdoComponent } from './certificacion-acuerdo/certificacion-acuerdo.component';
import { FacturasAcuerdoComponent } from './facturas-acuerdo/facturas-acuerdo.component';
import { FirmasAcuerdoComponent } from './firmas-acuerdo/firmas-acuerdo.component';

@Component({
  selector: 'app-vista-previa-acuerdo',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  imports: [
    CommonModule, 
    FormsModule, 
    ControlesAcuerdoComponent, 
    CertificacionAcuerdoComponent, 
    FacturasAcuerdoComponent, 
    FirmasAcuerdoComponent
  ],
  templateUrl: './vista-previa-acuerdo.component.html',
  styles: [`
...
export class VistaPreviaAcuerdoComponent {
