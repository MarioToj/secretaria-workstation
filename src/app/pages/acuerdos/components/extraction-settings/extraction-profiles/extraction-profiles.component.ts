...
import { SavedProfile } from '../../../interfaces/saved-profile.interface';
import { detectActiveProfile } from '../extraction-settings.helper';

@Component({
  selector: 'app-extraction-profiles',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule, FormsModule],
  templateUrl: './extraction-profiles.component.html'
})
export class ExtractionProfilesComponent {
  readonly defaultPatterns = input.required<ExtractionPatterns>();
