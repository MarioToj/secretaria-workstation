...
export function arePatternsEqual(p1: ExtractionPatterns, p2: ExtractionPatterns): boolean {
...
export function detectActiveProfile(
  currentPatterns: ExtractionPatterns,
  profiles: SavedProfile[],
  defaultPatterns: ExtractionPatterns
): string {
