...
describe('AnalizadorFacturaService - SAT FEL Invoice Parsing', () => {
  let service: AnalizadorFacturaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [AnalizadorFacturaService]
    });
    service = TestBed.inject(AnalizadorFacturaService);
  });
